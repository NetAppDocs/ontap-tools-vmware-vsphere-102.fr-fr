...
Pour obtenir la liste complète des nouvelles fonctionnalités et améliorations, consultez link:whats-new-otv-102.html["Nouveautés des outils ONTAP pour VMware vSphere 10.2"].
